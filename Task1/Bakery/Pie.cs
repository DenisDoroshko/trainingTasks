...
namespace Bakery
{
    ...
    public class Pie : BakeryProduct
    {
        ...
        /// <summary>
        /// Creates an instance of the Pie class
        /// </summary>
        /// <param name="name">Name of product</param>
        /// <param name="producedNumber">Number of products produced</param>
        /// <param name="composition">Product composition</param>

        public Pie(string name, int producedNumber, List<Ingredient> composition) : base(name, producedNumber, composition)
        {
        ...
        private ProductTypes type = ProductTypes.Pie;
