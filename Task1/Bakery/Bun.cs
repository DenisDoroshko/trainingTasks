...
namespace Bakery
{
    ...
    public class Bun : BakeryProduct
    {
        ...
        public Bun(string name, int producedNumber, List<Ingredient> composition) : base(name, producedNumber, composition)
        {
        ...
        private ProductTypes type = ProductTypes.Bun;
