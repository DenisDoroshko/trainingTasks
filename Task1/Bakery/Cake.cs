...
namespace Bakery
{
    ...
    public class Cake : BakeryProduct
    {
        ...
        /// <summary>
        /// Creates an instance of the Cake class
        /// </summary>
        /// <param name="name">Name of product</param>
        /// <param name="producedNumber">Number of products produced</param>
        /// <param name="composition">Product composition</param>

        public Cake(string name, int producedNumber, List<Ingredient> composition) : base(name, producedNumber, composition)
        {
